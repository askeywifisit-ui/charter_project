...
- GitHub 文件來源：<https://github.com/askeywifisit-ui/charter_project/blob/main/docs/charter_site/docs/test_suites/sanity/C15807850_UPnP_State_Changed_From_Enabled_To_Disabled.md>

- GitHub scripts（zip，需 repo 權限）：<https://raw.githubusercontent.com/askeywifisit-ui/charter_project/main/scripts/sanity/C15807850_UPnP_State_Changed_From_Enabled_To_Disabled.zip>
...
export SUITE="sanity"
export NAME="C15807850_UPnP_State_Changed_From_Enabled_To_Disabled"
...
```
- Suite: **sanity**
- Script ID（可能因 delete/import 變動）：`11F_140=5184`
- 版本（manifest version）：`v6`
