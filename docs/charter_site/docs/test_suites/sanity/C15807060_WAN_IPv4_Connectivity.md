...
- GitHub 文件來源：<https://github.com/askeywifisit-ui/charter_project/blob/main/docs/charter_site/docs/test_suites/sanity/C15807060_WAN_IPv4_Connectivity.md>

- GitHub scripts（zip，需 repo 權限）：<https://raw.githubusercontent.com/askeywifisit-ui/charter_project/main/scripts/sanity/C15807060_WAN_IPv4_Connectivity.zip>
...
export SUITE="sanity"
export NAME="C15807060_WAN_IPv4_Connectivity"
...
```
- Suite: **sanity**
- Script ID（可能因 delete/import 變動）：`11F_140=5169`
- 版本（manifest version）：`v1-Internet_connectivity`
