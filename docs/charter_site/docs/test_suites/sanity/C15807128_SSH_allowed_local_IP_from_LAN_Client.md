...
- GitHub 文件來源：<https://github.com/askeywifisit-ui/charter_project/blob/main/docs/charter_site/docs/test_suites/sanity/C15807128_SSH_allowed_local_IP_from_LAN_Client.md>

- GitHub scripts（zip，需 repo 權限）：<https://raw.githubusercontent.com/askeywifisit-ui/charter_project/main/scripts/sanity/C15807128_SSH_allowed_local_IP_from_LAN_Client.zip>
...
export SUITE="sanity"
export NAME="C15807128_SSH_allowed_local_IP_from_LAN_Client"
...
```
- Suite: **sanity**
- Script ID（可能因 delete/import 變動）：`11F_140=5214`
- 版本（manifest version）：`v2-force-ipv6-recheck`
