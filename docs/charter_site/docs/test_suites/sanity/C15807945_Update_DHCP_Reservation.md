...
- GitHub 文件來源：<https://github.com/askeywifisit-ui/charter_project/blob/main/docs/charter_site/docs/test_suites/sanity/C15807945_Update_DHCP_Reservation.md>

- GitHub scripts（zip，需 repo 權限）：<https://raw.githubusercontent.com/askeywifisit-ui/charter_project/main/scripts/sanity/C15807945_Update_DHCP_Reservation.zip>
...
export SUITE="sanity"
export NAME="C15807945_Update_DHCP_Reservation"
...
```
- Suite: **sanity**
- Script ID（可能因 delete/import 變動）：`11F_140=5186`
- 版本（manifest version）：`v1-precond-baseline-clearall-waitupdate`
