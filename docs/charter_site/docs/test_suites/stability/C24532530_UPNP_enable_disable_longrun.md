...
- GitHub 文件來源：<https://github.com/askeywifisit-ui/charter_project/blob/main/docs/charter_site/docs/test_suites/stability/C24532530_UPNP_enable_disable_longrun.md>

- GitHub scripts（zip，需 repo 權限）：<https://raw.githubusercontent.com/askeywifisit-ui/charter_project/main/scripts/stability/C24532530_UPNP_enable_disable_longrun.zip>
...
export NAME="C24532530_UPNP_enable_disable_longrun"
...
```
- Suite: **stability**
- Script ID（可能因 delete/import 變動）：`11F_140=5218`
- 版本（manifest version）：`v7_sshprecond_rebootwait90-tolerate-dumpcore-history-only`
...
??? note "manifest.yaml（流程參數完整；帳密/API key 已遮蔽）"
    ...
    suite: stability
    version: v7_sshprecond_rebootwait90-tolerate-dumpcore-history-only
    entrypoint: cycle_wrapper.py:run
    env:
      CYCLES: '1'
      CYCLE_INTERVAL: '90'
